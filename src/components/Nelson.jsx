...
export default function Nelson() {
  ...
  return (
    <section className='GroupStudent'>
        <h1 className = 'GSwelcome'> Welcome <span>Javier</span> to <span>G4</span></h1>
        <button className='btnContinuar' onClick={Continuar}>Continuar</button>
        <Cartas name = 'Nelson' carta = 'Aprecio profundamente tu paciencia y la manera en que has compartido tu experiencia conmigo. Me has mostrado que la verdadera enseñanza va más allá de los conocimientos; se trata de inspirar y motivar' />
   </section>
  )
}
